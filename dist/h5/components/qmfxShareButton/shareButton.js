...
export default class Index extends Component {
  ...
  render() {
    ...
    return <View className="poster">
                ...
                {showModal && <View className="content-share" onClick={this.onCancel.bind(this)}>
                            <View className="content-share-main">
                                ...
                                <View className="share">
                                    ...
                                    <Button className="friend" onClick={this.onSharaFriend.bind(this)}>
                ...
                {showPoster && <View className="content-poster" onClick={this.onCancelPoster.bind(this)}>         
