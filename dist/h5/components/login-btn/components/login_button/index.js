...
class LoginButtonComponent extends Taro.Component {
  render() {
    const { onLoginSuccess, onLoginFail, source } = this.props;
    ...
    return <View className="login-button-component-wrapper">
      <Button className="login-button-component-item" open-type="getPhoneNumber" onGetPhoneNumber={getPhone}>
