...
const CashierGoods = ({orderData, onPay}: Props) => {
  ...
  return (
    <View className="cashier-goods-wrapper">
        ...
        <View className="cashier-goods-goods-wrapper">
          ...
          <View className="cashier-goods-goods-main">
            <View className="cashier-goods-goods-left">
              {goods && goods.goodsList.map((goodsItem, index) => (
                <Image
                  mode="aspectFill"
                  webp
                  className="cashier-goods-goods-items-image"
                  key={`${goodsItem.thumb_url}${index}`}
                  src={goodsItem.thumb_url}
                />
              ))}
            </View>
          ...
          {orderData.coupon_name && (
            <View className="cashier-goods-goods-coupon">
      ...
      <View className="cashier-goods-price">
        <View className="cashier-goods-price-item-wrapper">
          {priceArr.map(priceItem => (
            <View className="cashier-goods-price-item" key={priceItem.name}>
