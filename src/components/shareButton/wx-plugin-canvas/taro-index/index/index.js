...
class _C extends Taro.Component {
  ...
  componentWillMount(){
    ...
    // }
    this.$scope.downloadResource = this.methods.downloadResource.bind(this)
    this.$scope.create = this.methods.create.bind(this)
  }
  ...
  render() {
    const { debug, pxWidth, pxHeight } = this.state
    return (
