...
export async function getSession(api, code) {
...
class LoginStore {
  constructor() {
    this.nowSessionData = { session_id: '', access_token: '', expires_in: '' };
  }
  getNowSessionData() {
    return this.nowSessionData || {};
  }
  isEmpty() {
    return !this.nowSessionData || !this.nowSessionData.session_id || !this.nowSessionData.access_token;
  }
