...
export default class Index extends Component {
  ...
  render() {
    const { name, mobile, location, street, onCallBack } = this.props;
    return <View className="container" onClick={this.oncallBack.bind(this)}>
                {name && location ? <View className="__display">
                            ...
                            {onCallBack && <View style="margin-left:auto;margin-right:20rpx;flex-shrink:0">
                                        <AtIcon value="chevron-right" color="#999" size="24" />
                                    </View>}
                          
                        </View> : <View className="__noAddress">
                            <Image src={addIcon} />
                            <View>请添加收货地址</View>
                            {onCallBack && <View style="margin-left:auto;margin-right:20rpx;flex-shrink:0">
                                        <AtIcon value="chevron-right" color="#999" size="24" />
