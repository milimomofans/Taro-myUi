...
import {checkRules, handleError, ValidData} from '../../utils/validator'
...
class LoginPhone extends Component<Props, LoginPhoneState> {
      ...
      <View className={outerClass}>
        <View className="login-main-form-item">
          <Input
            ...
            className="item-right-input-item"
